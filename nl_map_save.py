...
test_loader = iter(Data.DataLoader(dataset=test_data, batch_size=1, shuffle=True))
...
net.load_state_dict(torch.load('weights/net_new.pth'))


img_batch, label_batch = test_loader.__next__()
img_batch = img_batch.cuda()
label_batch = label_batch.cuda()
print('img_batch: ', img_batch.size())
...
# (b, h1*w1, h2*w2)
print('nl_mep_list.size: ', len(nl_mep_list))
